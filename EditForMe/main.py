...
def main():
    parser = argparse.ArgumentParser(description="AI Python Code Generator")
...
3. Now a chat interface will open where you can prompt your script idea to the AI and the AI will generate the Python code.
...
5. You can also continue the chat after the code has been created to make changes in your script. 
